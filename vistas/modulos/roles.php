<div class="container-fluid">
		...
		<div class="container py-5">
            ...
            <div class="d-flex justify-content-center text-center py-3">
                ...
                <form class="p-5 bg-light" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <label for="precio">Nombre del Rol</label>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="precio" name="nombreRol" placeholder="Ingrese su rol">
            ...
            $roles = ControladorRoles::ctrRoles();
