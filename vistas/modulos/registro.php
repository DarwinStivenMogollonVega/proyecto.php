                ...
                <form class="p-5 bg-light" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="telefonoPersona" name="registroTelefono" pattern="[0-9+]+" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="correoPersona" name="registroEmail" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="contraseñaPersona" name="registroClave" requiered>
